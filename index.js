...
if (process.argv.length > 3) {
	...
	mp4boxfile.onReady = function(info) {
		...
		for (var i = 0; i < info.tracks.length; i++) {
			//console.log(info.tracks[i], process.argv[3]);
		...
		console.log(
			//mp4boxfile.boxes[2].traks[0].mdia.minf.stbl.stsd.entries[0].boxes
		...
		//console.log(MP4Box.BoxParser.mp4aSampleEntry.getCodec());
